...
<head>
    <meta charset="UTF-8">
    <title>ใบผลการแข่งขันงานสัปดาห์วิทยาศาสตร์แห่งชาติ</title>
...
<body>
    ...
    <div class="header">
        <h3>ใบผลการแข่งขันงานสัปดาห์วิทยาศาสตร์แห่งชาติ ประจำปี {{ $activity->year }}</h3>
    </div>
                        ...
                        @foreach ($teamMembers as $memberIndex => $member)
                            <tr>
                                @if($memberIndex === 0)
                                    ...
                                    <td rowspan="{{ count($teamMembers) }}"></td>
                                @else
                                    <td>{{ $member }}</td>
                                @endif
